...
echo "2. Download datasets: python ml/data/fetch_datasets.py --all"
echo "3. Process data: python ml/data/ingestion.py --all"
echo "4. Train model: python ml/training/train.py --config configs/mert_95m.yaml"
